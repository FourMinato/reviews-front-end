...
export let ignoreList: string[] = [
    "หีบ", "สัสดี", "หน้าหีบ", "ตด", "กะหรี่ปั๊บ", "บ้าน", "hello", "hi", "hey", "assam", "assess", "assessment", "classic", "classicist", "passage", "passenger", "grass", "grassland", "mass", "massive", "compass", "bass", "bassoon", "casserole", "classroom", "passion", "passionate", "passionfruit"
];

export let rootWords: string[] = [
    "ควย", "เหี้ย", "หี", "สัส", "เชี่ย", "แรด", "กระหรี่", "ชิบหาย", "ตอแหล", "เเตด", "แตด", "ห่า", 
